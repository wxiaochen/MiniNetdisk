...
<div class="container" style="width:400px; margin-top:180px;">
	...
	<div class="input-group " style="margin-bottom:20px;">
		...
		<input type="text" class="form-control" placeholder="邮箱或用户名" style="width:213px">
	</div>

	<div class="input-group" style="margin-bottom:20px">
		<span class="input-group-addon" style="width:50px;">密码</span>
		<input type="text" class="form-control" style="width:213px" placeholder="请输入您的密码">
	</div>
	<div class="input-group" style="margin-bottom:20px;">
		<form action="#" method="post">
			<input type="submit" class="btn btn-info" style="width:95px;background:#46A3FF; color:white;" value="登录" >
			<a href="regist.html" style="text-decoration:none;font-size:20px; margin-left:90px;">点我注册</a>
		</form>
	</div>
</div>
</body>
